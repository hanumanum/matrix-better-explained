 ...
 *   SOFT_LIGHT, DODGE, BURN, ADD or NORMAL.
 */
declare function blend(srcImage: p5.Image|undefined, sx: number, sy: number, sw: number, sh: number, dx: number, dy: number, dw: number, dh: number, blendMode: BLEND_MODE): void;
 ...
 *   @param dh destination image height
 */
declare function copy(srcImage: p5.Image|p5.Graphics|undefined, sx: number, sy: number, sw: number, sh: number, dx: number, dy: number, dw: number, dh: number): void;
 ...
 *   data
 */
declare function downloadFile(data: string|any, filename?: string, extension?: string): void;
