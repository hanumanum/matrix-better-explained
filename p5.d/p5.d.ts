...
declare class p5 {
   ...
   *   SOFT_LIGHT, DODGE, BURN, ADD or NORMAL.
   */
  blend(srcImage: p5.Image|undefined, sx: number, sy: number, sw: number, sh: number, dx: number, dy: number, dw: number, dh: number, blendMode: BLEND_MODE): void
   ...
   *   data
   */
  downloadFile(data: string|any, filename?: string, extension?: string): void
